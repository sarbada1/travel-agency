                ...
                <div class="col-lg-12">
                    <div class="py-3 card">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <h2><i class="bi bi-pencil-square"></i> Edit Attribute Group
                            ...
                            <div class="row">
                                ...
                                <form action="{{route('manage-attribute-group.update', $attributeGroup->id)}}" method="post">
                                    @csrf
                                    @method('PUT')
                                    <div class="row">
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3 form-group">
                                                ...
                                                <input type="text" id="slug" name="slug"
                                                       class="form-control"
                                                       value="{{old('slug', $attributeGroup->slug)}}">
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3 form-group">
                                        ...
                                        <textarea name="description" id="description"
                                                  class="form-control" rows="5">{{old('description', $attributeGroup->description)}}</textarea>
                                    </div>

                                    <div class="col-md-12">
                                        <button class="btn btn-success w-100">
                                            <i class="bi bi-check-circle"></i> Update Attribute Group
                                        </button>
                                    </div>
                                </form>
                            </div>
