                                        ...
                                        <div class="col-md-6">
                                            <div class="mb-3 form-group">
                                                ...
                                                <select name="page_type" class="form-control" id="page_type">
                                                    ...
                                                    <option value="tour_package" {{old('page_type') == 'tour_package' ? 'selected' : ''}}>
                                                        Tour Package
                                                    </option>
                                                    <option value="destination" {{old('page_type') == 'destination' ? 'selected' : ''}}>
                                                        Destination
                                                    </option>
                                                    <option value="activity" {{old('page_type') == 'activity' ? 'selected' : ''}}>
                                                        Activity
                                                    </option>
                                                    <option value="travel-guide" {{old('page_type') == 'travel-guide' ? 'selected' : ''}}>
                                                        Travel Guide
                                                    </option>
                                                </select>
                                            </div>
