        ...
        <section class="section dashboard">
            <div class="card py-3">
                <div class="card-body">
                    <div class="row">
                        <div class="col-md-12">
                            <h2>
                                ...
                                Add Location
                                <a href="{{route('manage-location',$countryData->id)}}" class="btn btn-primary btn-sm float-end">Show
                                    Locations</a>
                            </h2>
                            <hr>
                        </div>
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <form action="{{route('manage-location-add',$countryData->id)}}" method="POST" enctype="multipart/form-data">
                                @csrf
                                ...
                                <div class="mt-3">
                                    <button class="btn btn-primary w-100">Add Location</button>
                                </div>
                            </form>
                        </div>
                    </div>
