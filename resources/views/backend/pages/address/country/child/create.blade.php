                ...
                <div class="col-lg-12">
                    <div class="card py-3">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <h2><i class="bi bi-plus-circle"></i> Add Country Page
                                        <a href="{{route('country-page',$pid)}}"
                                           class="btn btn-success btn-sm float-end">
                                            <i class="bi bi-eye-fill"></i> Show Country Page</a>
                                    </h2>
                                    <hr>
                            ...
                            <div class="row">
                                <form action="{{route('country-page-create',$pid)}}" method="post"
