                ...
                <div class="col-lg-12">
                    <div class="card py-3">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <h2><i class="bi bi-plus-circle"></i> Add Country Content
                                        <a href="{{route('country-content',$pid)}}"
                            ...
                            <div class="row">
                                <form action="{{route('country-content-create',$pid)}}" method="post"
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-12">
                                            <button class="btn btn-success w-100">
                                                <i class="bi bi-plus-circle"></i> Add Country Content
                                            </button>
                                        </div>
                                    </div>
                                </form>
