                ...
                <div class="col-lg-12">
                    <div class="card py-3">
                        <div class="card-body">
                            <div class="row">
                                <div class="col-md-12">
                                    <h2><i class="bi bi-pencil-square"></i> Update Country Content
                                        <a href=""
                                           class="btn btn-success btn-sm float-end">
                                            <i class="bi bi-eye-fill"></i> Show Country Content</a>
                                    </h2>
                                    <hr>
                            ...
                            <div class="row">
                                <form action="{{route('country-content-update',$pcData->id)}}" method="post"
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <div class="form-group mb-3">
                                                ...
                                                <select name="parent_id" class="form-control" id="parent_id">
                                                    <option value="{{$pcData->country->id}}">
                                        ...
                                        <div class="col-md-12">
                                            <button class="btn btn-success w-100">
                                                <i class="bi bi-pencil-square"></i> Update Country Content
                                            </button>
                                        </div>
                                    </div>
                                </form>
